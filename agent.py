...
INTENT_TEMPLATES = [
    ...
    },
    {
        ...
        "dsl":      lambda: {"query": {"term": {"log.level": "ERROR"}},
    ...
    },
    {
        ...
        "dsl":      lambda: {"aggs": {"by_level": {"terms": {"field": "log.level", "size": 10}}},
                             "size": 0},
    },
    {
        ...
        "dsl":      lambda: {"aggs": {"min_time": {"min": {"field": "@timestamp"}},
